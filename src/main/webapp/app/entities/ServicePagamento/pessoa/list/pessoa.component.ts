...
export class PessoaComponent implements OnInit {
  ...
  protected readonly pessoaService = inject(PessoaService);
  ...
  trackId = (item: IPessoa): number => this.pessoaService.getPessoaIdentifier(item);
